...
/// 创建日期
String? date;
UserEditModel({required this.date,required this.email,required this.id,required this.name,required this.state});
static UserEditModel fromJson(String json){
    ...
    return UserEditModel(date: map["date"],email: map["email"],id: map["id"],name: map["name"],state: map["state"]);
