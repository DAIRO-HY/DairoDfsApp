  ...
  Widget build(BuildContext context) {
    return Row(children: [
      TextButton(
          ...
          child: SizedBox(width: UCAccountItem.HEIGHT, height: UCAccountItem.HEIGHT, child: Icon(Icons.remove_circle, color: Colors.red))),
      Expanded(
          child: TextButton(
              style: TextButton.styleFrom(
                  minimumSize: const Size(0, 0), // 选填：设置最小尺寸
              ...
              child: Container(
                  ...
                  child: Row(children: [
                    ...
                    const Spacer(),
                    Icon(Icons.chevron_right, color: context.color.secondary),
                    Gap(10)
                  ]))))
    ]);
  }
