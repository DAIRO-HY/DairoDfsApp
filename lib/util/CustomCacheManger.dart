...
/// instance.
class CacheManager123 implements BaseCacheManager {
  ...
  Stream<FileResponse> getFileStream(String url,
    ...
    final cacheFile = this._pushFileToStream123(key,url);
  }

  Future<String> _pushFileToStream123(
      String url,
      String key
      ) async {
    this._store.getFile(key);
    return "";
  }
